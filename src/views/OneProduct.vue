...
const category = url.includes("IT-solution")
  ? "IT-solution"
  : url.includes("Surveillance-systems")
  ? "Surveillance-systems"
  : url.includes("Fingerprints")
  ? "Fingerprints"
  : null;
...
<template>
  <div class="mt-24 flex flex-col lg:flex-row w-full lg:w-11/12 mx-auto">
    ...
    <div class="lg:w-6/12 lg:px-4 flex flex-col justify-center mt-5 lg:mt-0">
      ...
      <p class="my-5 text-lg text-center lg:text-left">
        Brand : {{ oneProd.brand }}
      </p>
      <p class="text-slate-700 text-center lg:text-left">
        {{ oneProd.description }}
      </p>
    </div>
  </div>
  <div class="flex w-11/12 mx-auto">
    <button
      @click="goBack()"
      class="primary-btn block mx-auto my-10 lg:mx-6 lg:ms-auto mt-5 lg:mt-0"
    >
      Back To Products
    </button>
  </div>
