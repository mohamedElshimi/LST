<template>
  <section class="container my-10">
    <div class="flex flex-wrap justify-center items-center">
      <div
        class="flex sm:justify-end justify-center md:border-r-8 border-r-0 md:border-b-0 border-b-8 sm:w-auto w-full border-secondry"
      >
        <img
    ...
    <div
      class="border-4 border-secondry border-dashed rounded-3xl mt-5 relative"
    >
      <div
        class="w-[200px] h-[100px] bg-white absolute bottom-0 right-10 rotate-45 border-4 border-secondry border-dashed z-10"
      ></div>
